...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
   ...
   </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1" style="background-color:#1D1D1D;padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;height:50px;">
   ...
   <div class="x-col x-col-20 x-col-15" xid="col7"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button1" icon="linear linear-user" style="position:relative;left:45%;color:#C0C0C0;">
   <i xid="i1" class="linear linear-user"></i>
   <span xid="span3"></span></a></div></div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3" style="background-color:#1D1D1D;padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;height:60px;">
   ...
   <div class="x-col x-col-20 x-col-15" xid="col8">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button2" icon="icon-laptop" style="position:relative;left:45%;color:#C0C0C0;">
     <i xid="i2" class="icon-laptop"></i>
     <span xid="span5"></span></a> </div> </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4" style="background-color:#1D1D1D;padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;height:60px;">
   ...
   <div class="x-col x-col-20 x-col-15" xid="col11">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button3" icon="glyphicon glyphicon-bitcoin" style="position:relative;left:45%;color:#C0C0C0;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5" style="background-color:#1D1D1D;padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;height:40px;">
   ...
   <div class="x-col x-col-20 x-col-15" xid="col14">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button4" icon="icon-ios7-keypad" style="position:relative;left:45%;color:#C0C0C0;">
