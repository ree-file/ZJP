...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <span xid="span2" style="font-size:medium;color:#FFFFFF;position:absolute;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;left:75%;top:62px;"><![CDATA[]]></span></div>
   </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row3" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;position:relative;background-color:#1C1F26;height:80px;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row8" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;height:100%;position:relative;">
   <div class="x-col x-col-33" xid="col20" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;position:relative;height:100%;"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon btn-block" label="button" xid="button2" icon="e-commerce e-commerce-renminbi" style="color:#FFFFFF;position:relative;font-size:xx-large;padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;height:100%;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row9" style="margin:8px 0px 0px 0px;position:relative;border-right-style:groove;border-right-width:thin;padding-right:0px;padding-bottom:0px;padding-left:0px;">
   <div class="x-col" xid="col23" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;position:relative;"><span xid="span6" style="font-size:large;color:#FFFFFF;position:relative;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;left:7%;top:1%;"><![CDATA[]]></span></div>
   </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row10" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;border-right-style:groove;border-right-width:thin;position:relative;">
   <div class="x-col" xid="col26" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;"><span xid="span8" style="font-size:x-small;color:#C3C3C3;position:relative;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;left:7%;"><![CDATA[]]></span></div>
   </div></div>
   </div></div>
   ...
   <div class="x-col" xid="col31" style="margin:0px 0px 0px 0px;position:relative;padding-right:0px;padding-bottom:0px;padding-left:0px;">
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row12" style="margin:8px 0px 0px 0px;position:relative;padding-right:0px;padding-bottom:0px;padding-left:0px;">
     <div class="x-col" xid="col30" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;position:relative;">
      <span xid="span14" style="font-size:large;color:#FFFFFF;position:relative;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;left:7%;top:1%;"><![CDATA[]]></span></div> </div> 
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4" style="background-color:#1C1F26;padding-top:3px;padding-bottom:9px;margin-top:25px;">
   ...
   <div class="x-col" xid="col2" style="margin-right:0px;margin-bottom:0px;margin-left:0px;padding:3px 0px 0px 0px;">
    <span xid="emailSpan" style="font-size:large;color:#FFFFFF;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;position:relative;top:1px;left:7px;"><![CDATA[]]></span></div> 
   <div class="x-col x-col-20" xid="col5">
    </div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row19" style="background-color:#1C1F26;padding-top:3px;padding-bottom:9px;">
   <div class="x-col x-col-25 pull-right center-block" xid="col28" style="margin:0px 0px 0px 0px;padding:0px 0px 0px 0px;">
    <span xid="span27" style="font-size:medium;color:#FFFFFF;position:relative;font-family:微软雅黑 Light;text-transform:capitalize;font-style:normal;top:5px;right:13px;font-variant:small-caps;" class="pull-right center-block"><![CDATA[]]></span></div> 
   <div class="x-col" xid="col41" style="margin-right:0px;margin-bottom:0px;margin-left:0px;padding:3px 0px 0px 0px;">
    <span xid="IDspan" style="font-size:large;color:#FFFFFF;font-family:微软雅黑 Light;text-transform:lowercase;font-style:inherit;position:relative;top:1px;left:7px;"></span></div> 
   <div class="x-col x-col-20" xid="col35"></div></div><div component="$UI/system/components/justep/row/row" class="x-row meddlerow" xid="inviteRow" style="background-color:#1C1F26;" bind-click="inviteRowClick">
   ...
   <div class="x-col" xid="col1"><span xid="span3" style="font-size:medium;color:#FFFFFF;position:relative;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;left:8px;top:2px;"><![CDATA[]]></span></div>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row " xid="hidRow" style="margin:2px 0px 0px 0px;padding:2px 0px 40px 30px;background-color:#1C1F26;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5" style="padding:0px 0px 0px 0px;margin:6px 0px 0px 0px;height:30px;position:relative;top:5px;">
   ...
   <div class="x-col x-col-20" xid="col10">
    </div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row6" style="padding:0px 0px 0px 0px;margin:8px 0px 0px 0px;height:30px;position:relative;top:10px;">
   <div class="x-col x-col-20 center-block" xid="col15" style="padding:12px 0px 0px 0px;margin:0px 0px 0px 0px;">
    <span xid="span13" style="font-size:small;color:#FFFFFF;position:relative;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;right:20px;" class="pull-right center-block"><![CDATA[]]></span></div> 
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7" style="padding:0px 0px 0px 0px;margin:8px 0px 0px 0px;height:30px;position:relative;top:15px;">
   <div class="x-col x-col-20 center-block" xid="col16" style="padding:12px 0px 0px 0px;margin:0px 0px 0px 0px;">
    <span xid="span17" style="font-size:small;color:#FFFFFF;position:relative;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;right:20px;" class="pull-right center-block"><![CDATA[]]></span></div> 
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row meddlerow" xid="row16" style="background-color:#1C1F26;" bind-click="row16Click">
   <div class="x-col" xid="col19">
    <span xid="span22" style="font-size:medium;color:#FFFFFF;position:relative;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;left:8px;top:2px;"><![CDATA[]]></span></div> 
   ...
   <div class="x-col" xid="col36" style="position:relative;">
    <span xid="span21" style="font-size:medium;color:#FFFFFF;position:relative;font-family:微软雅黑 Light;font-variant:small-caps;text-transform:lowercase;font-style:inherit;left:8px;top:2px;"><![CDATA[]]></span></div> 
  ...
  </div><span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog1" src="$UI/ZJP/mailLogin.w" onReceive="windowDialog1Receive"></span> 
</div>