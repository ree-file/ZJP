	...
	return {
		...
		transferGetmoney:["提现","提交后请等待申请核实","卡号","开户行","银行名称",
		               ...
		               "市场金额","其他银行","上传图片","可提$","本次提取金额分配",
									 "入户金额","激活金额","备用金额","确定","取消"],
		transferMymoney:["转账","转账为即刻到账","对方ID","金额$","支付密码",
										"提交","本次提取金额分配","转账金额","钱包金额","提取金额",
										"确定","取消","总金额不足"],
		transferRecord:["无任何提现转账记录","记录","编号","金额","转出金额",
										"备用金额","激活金额","时间","转出","转入",
										"对方ID","充值记录","提现记录","转账记录","处理",
										"成功","拒绝","卡号","投资记录","创建",
										"升单","复投","猫窝ID","消耗金额","猫窝名称"],
		wallet:["钱包","钱包金额","重置支付密码","/已废除/市场金额","激活金额",
		        "备用金额","钱包金额—充值孵化获得的流动金额","/已废除/市场金额—通过钱包充值用于市场购买的金额","备用金额—通过提现获得的金额","激活金额—通过提现获得只能用于激活的金额",
				"充值","提现","转账","记录","提现金额",
				"提现金额—每日钱包金额6%汇入可用于抵用的金额","总金额","$ "],
		ZJP_main:["天使猫","今日收益","总投资","钱包","日期",
		          "小猫","猫窝","类型","首页","猫窝",
		          "市场","个人中心","二级密码：","确认密码：","确认",
		          "钱包","备用","限制","邀请","日常",
		          "只","钱包猫","限制猫","备用猫","金额"],
		nestjs : ["天使猫窝","详情","收益率","投资金额","猫仔数",
		          "已收获","日常获得","邀请获得","家族获得"],
		...
		personaljs:["修改成功",'转账成功','转账失败，请确认ID，金额，密码是否错误','提交成功','查询成功',
								'查询失败，请重新查询'],
		marketjs:["产品正在出售中"],
