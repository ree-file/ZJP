	...
	return {
		showprompt:['请重新登录','邮箱不能为空','密码不能为空',"账号或者密码错误","账号或者密码不能为空",
		            ...
		            "不能买自己的产品",'产品不在销售中',"超过100才能提现","请重新选择网路并刷新页面","需要上传凭证",
								"请选择银行","请输入正确的银行卡号","请输入正确的银行卡号和提款金额","请完整输入数据"],
		bankAddind:['银行卡添加','请绑定持卡本人的银行卡','持卡人','卡号','银行','提交并审核','其他银行'],
		bankBanding:['银行卡绑定','添加银行卡','删除'],
		community:["家族","家族结构","家族福利","家族人数","直接加速",
							"家族加速","A家族","B家族","C家族","总情况",
							"子数","孙数"],
		...
		transferMymoney:["转账","转账为即刻到账","对方ID","金额$",
										"支付密码","提交"],
		transferRecord:["无任何提现转账记录","记录","编号","转账金额","转出金额",
										"猫币","激活金额","时间","转出","转入"],
		wallet:["钱包","钱包金额","重置支付密码","/已废除/市场金额","激活金额",
		        "猫币","钱包金额—通过充值存进账户的金额","/已废除/市场金额—通过钱包充值用于市场购买的金额","激活金额—通过提现获得只能用于激活的金额数","猫币—通过提现获得用于限制提现金额",
						"充值","提现","转账","记录"],
