define(function(require){
	...
	return {
		...
		transfermoney:["充值转账","请确保已汇款后再提交，钱包金额与交流金额互相转款为立即生效。","卡号","来源","银行名",
		               "去向","金额","支付密码","提交","钱包金额",
		               "市场金额","其他银行"],
		wallet:["钱包","钱包金额","重置支付密码","市场金额","激活金额",
		        "总金额","钱包金额—通过充值存进账户的金额数","交易金额—通过孵化获得自由交易的金额数","激活金额—通过孵化获得只能用于激活的金额数","充值&转账"],
		...
		personal:["修改成功",'转账成功','转账失败，请确认金额，来源，去向等','提交成功','查询成功']
	}
});