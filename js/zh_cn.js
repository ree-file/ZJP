define(function(require){
	...
	return {
		...
		wallet:["钱包","钱包金额","重置支付密码","市场金额","激活金额",
		        "总金额","钱包金额—通过充值存进账户的金额数","交易金额—通过孵化获得自由交易的金额数","激活金额—通过孵化获得只能用于激活的金额数","充值","提现","转账"],
		ZJP_main:["天使猫","今日收益","总投资","总金额","日期",
		          "金额","猫窝","类型","首页","猫窝",
		          "市场","个人中心","二级密码：","确认密码：","确认",
		          "市场","活动","限制"],
		nestjs : ["天使猫窝","详情","收益率","投资金额","释放金额",
		          "冻结金额","日常获得","邀请获得","家族获得"],
		ZJP_production:["请输入以下信息","产品价值","提升等级","邀请猫窝","邮箱地址",
		...
		personaljs:["修改成功",'转账成功','转账失败，请确认金额，来源，去向等','提交成功','查询成功']
	}
});
