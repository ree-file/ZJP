...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full background-color-black" xid="panel1">
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7" style="padding-top:1px;">
    <div class="x-col x-col-25 center-block" xid="col13" style="vertical-align:middle;text-align:left;">
     <h5 xid="h53" style="font-size:medium;font-family:华文细黑;font-weight:500;color:#FFFFFF;"><![CDATA[验证码]]></h5></div> 
    <div class="x-col" xid="col15" style="padding-bottom:0px;">
     <input component="$UI/system/components/justep/input/input" class="input-group-addon" xid="input1" placeHolder="输入邮箱中的验证码"></input></div> </div> </div>
  <div xid="div1" class="div-padding">
   <a component="$UI/system/components/justep/button/button" class="btn blueButton btn-default btn-block" label="下一步" xid="button1">
    <i xid="i1"></i>
    <span xid="span2">下一步</span></a> 
