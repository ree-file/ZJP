...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    ...
    <div class="x-panel-content" xid="content1" style="display:none;height:100%;padding-top:100px;"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1">
  ...
  <div class="x-col x-col-10" xid="col21"></div></div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row5" style="margin-bottom:10px">
   <div class="x-col" xid="col15" style="text-align:center"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" xid="button1" style="width:100%;border-color:#FFFFFF #FFFFFF #FFFFFF #FFFFFF;" onClick="button1Click">
   <i xid="i1"></i>
   <span xid="span5" style="color:white"></span></a></div>
  </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row6">
   <div class="x-col" xid="col18" style="text-align:center"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" xid="button2" style="width:100%;border-color:#FFFFFF #FFFFFF #FFFFFF #FFFFFF;" onClick="button2Click">
   <i xid="i2"></i>
   <span xid="span6" style="color:white"></span></a></div>
   </div>
  <div xid="div1" style="padding:20px;"><p xid="p1" style="color:white;padding:20px;"><![CDATA[]]></p></div></div>
  </div> 
