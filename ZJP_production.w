...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div xid="div3" class="production-upgrade"><div component="$UI/system/components/justep/row/row" class="x-row upgrade1" xid="upgrade-message">
   ...
   <div class="x-col x-col-67" xid="col11"><span xid="span18"><![CDATA[1800]]></span></div>
   </div>
  ...
  <div xid="div6"><span xid="span4"><![CDATA[所要提升等级：]]></span></div></div>
   <div class="x-col x-col-50" xid="col14"><select component="$UI/system/components/justep/select/select" bind-optionsCaption="请选择..." class="form-control input-sm" xid="select1" style="height:auto;"></select></div>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row necessary_money" xid="necessary_money">
   ...
   <div class="x-col x-col-67" xid="col18"><span xid="span10"><![CDATA[600]]></span></div></div>
  <div component="$UI/system/components/justep/row/row" class="x-row my_money" xid="my_money">
   ...
   <div class="x-col x-col-67" xid="col21"><span xid="span11"><![CDATA[1800]]></span></div></div>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row submit" xid="submit">
   ...
   <div class="x-col" xid="col29"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" label="确定" xid="button6">
   <i xid="i6"></i>
   <span xid="span19">确定</span></a></div>
  <div class="x-col" xid="col32"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm" label="重置" xid="button7">
   <i xid="i7"></i>
