...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" onParamsReceive="modelParamsReceive" style="top:32px;left:296px;height:auto;"><div component="$UI/system/components/justep/data/data" autoLoad="true" xid="typedata" idColumn="id"><column name="id" type="Integer" xid="xid1"></column>
...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div class="x-col x-17" xid="col35"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon" label="帮助" xid="button5" icon="img:$UI/ZJP/images/helps.gif|" onClick="button5Click">
   <i xid="i4"></i>
   <img src="$UI/ZJP/images/helps.gif" xid="image4"></img><span xid="span15">帮助</span></a></div></div><div component="$UI/system/components/justep/row/row" class="x-row normalRow" xid="necessary_money">
