define(function(require){
	...
	Model.prototype.input1Focus = function(event){
		$(this.getElementByXid("input1")).css("border-color","#5D92E2");
		$(this.getElementByXid("input1")).css("border-width","0px 0px 2px 0px");

	};

	Model.prototype.input1Blur = function(event){
		$(this.getElementByXid("input1")).css("border-color","#FFFFFF");
		$(this.getElementByXid("input1")).css("border-width","0px 0px 1px 0px");
	};
